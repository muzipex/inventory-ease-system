  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-slate-900 transition-colors duration-300">
      ...
      <header className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-sm shadow-lg border-b border-blue-100 dark:border-gray-700 transition-colors duration-300">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              <div className="relative">
                ...
                <div className="relative bg-white dark:bg-gray-800 rounded-lg px-3 py-2 border border-blue-200 dark:border-gray-600 transition-colors duration-300">
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="text-xs font-medium text-gray-600 dark:text-gray-400 tracking-wide uppercase border-l border-gray-300 dark:border-gray-600 pl-2">
                      Inventory System
                    </div>
                  </div>
                </div>
                ...
                <Link
                  ...
                  className={`flex items-center px-4 py-2 text-sm font-medium rounded-xl transition-all duration-200 ${
                    location.pathname === item.href
                      ...
                      : 'text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/50 dark:hover:to-purple-900/50 hover:text-blue-700 dark:hover:text-blue-300 hover:shadow-md'
                  }`}
                >
            ...
            <div className="flex items-center space-x-2">
              ...
              <Button
                ...
                className="p-2 hover:bg-blue-50 dark:hover:bg-gray-700 transition-colors duration-200"
        ...
        {/* Mobile Navigation */}
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-blue-100 dark:border-gray-700 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm transition-colors duration-300">
                ...
                <Link
                  ...
                  className={`flex items-center px-3 py-3 text-base font-medium rounded-lg transition-all duration-200 ${
                    location.pathname === item.href
                      ...
                      : 'text-gray-700 dark:text-gray-300 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 dark:hover:from-blue-900/50 dark:hover:to-purple-900/50 hover:text-blue-700 dark:hover:text-blue-300'
                  }`}
