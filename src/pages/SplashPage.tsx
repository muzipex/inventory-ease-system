...
const SplashPage = () => {
  ...
  const LoadingSpinner = () => (
    <div className="flex items-center justify-center">
      ...
      <span className="ml-2 text-white font-medium">Building access...</span>
    </div>
  );
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-3 text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 group"
